          ...
          <div className="container">
            <div className="row mt-4">
              ...
              <div className="col-md-4">
                ...
                <input
                  type="text"
                  className={`form-control mb-2 ${errors.offerCode ? "is-invalid" : ""}`}
                  placeholder="Enter Offer Code"
                  value={offerCode}
                  onChange={(e) => setOfferCode(e.target.value)}
                />
                {errors.offerCode && <div className="text-danger">{errors.offerCode}</div>}
                <button className="btn btn-dark w-100" onClick={handleApplyDiscount}>
                  Apply
                </button>
                <hr />
                <p>
